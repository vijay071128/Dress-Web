...
const Hero = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      >
        <div
          className="absolute inset-0 bg-gradient-to-br from-background/80 via-background/60 to-background/40"
          style={{
      ...
      <div className="relative z-10 container mx-auto px-4 text-center">
        ...
        >
          <motion.p
            ...
            className="text-sm md:text-base font-medium tracking-widest text-primary uppercase mb-4"
          >
